...
# Development paths
export PATH="$HOME/.config/emacs/bin:$HOME/.cargo/bin:$HOME/.local/bin:$HOME/.local/share/nvim/mason/bin:/usr/local/go/bin:$HOME/go/bin:$HOME/.dotnet/tools:$HOME/.fly/bin:$PATH"
